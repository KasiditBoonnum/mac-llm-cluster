...
curl -s http://localhost:5678/v1/chat/completions \
    ...
    -d '{"model":"mlx-community/Qwen3.6-35B-A3B-8bit","messages":[{"role":"user","content":"Generate a comprehensive dataset of 5000 fictional product entries for an e-commerce database. Each entry must include:\n\n1. Product ID (sequential)\n2. Product name (creative, varied)\n3. Category (electronics, clothing, home, sports, books, toys, food, etc.)\n4. Price (realistic range $5-$5000)\n5. Description (50-80 words describing features, benefits, materials, use cases)\n6. Specifications (3-5 technical specs)\n7. Stock quantity\n8. Supplier name\n9. SKU code\n10. Tags (5-8 relevant keywords)\n\nFormat as JSON array. Make each product unique and realistic. Include diverse categories and price points. Vary the descriptions significantly - no repetitive templates. Generate all 2000 entries."}],"max_tokens":52000,"stream":true,"enable_thinking":false,"presence_penalty":0,"frequency_penalty":0,"temperature":1.0}' \
    --no-buffer | python3 -c "
